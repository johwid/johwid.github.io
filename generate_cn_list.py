...
# Build word list
content={"title":"Mandarin","catchPhrase":"Test how well you know Mandarin","words":{}}
words=[]
...
with open(inputFile) as f:
    for line in f:
        ...
        if(len(lineArray)!=1):
            ...
            words.append({"cn":lineArray[0].strip(),"simplified":lineArray[1].strip(),"eng":lineArray[2].strip(),"category":lineArray[3].split(";")})
